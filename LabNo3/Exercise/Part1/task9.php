...
{
    public static $fastestAnimal = '';
    public static $fastestResult = 0;
    ...
    /**
     * Calculates average animal speed and sets fastest animal results
     * 
     * @param integer $distance
     * @param integer $time
     * 
    ...
    public function averageAnimalSpeed($distance, $time)
    {
        ...
        if ($averageAnimalSpeed > self::$fastestResult) {
            self::$fastestAnimal = $this->name;
            self::$fastestResult = $averageAnimalSpeed;
        }
...
print 'Fastest animal is ' . $simba::$fastestAnimal . ' with result ' .  $simba::$fastestResult;
